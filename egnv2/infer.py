...
from egnv2.exemplar_builder import compute_exemplar_agg_features
...
def main():
    parser = argparse.ArgumentParser(description="EGNv2 Inference")
    parser.add_argument("--checkpoint", type=str, required=True,
                        help="best_egnv2.pth 路径")
    ...
    # 计算 exemplar 聚合特征
    val_exemplar_agg = compute_exemplar_agg_features(
