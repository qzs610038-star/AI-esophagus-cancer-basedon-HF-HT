...
if args.task == 'task_1_tumor_vs_normal':
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/ESCC_pCR_clam.csv',
                            shuffle = False,
                            seed = args.seed,
                            print_info = True,
    ...
    args.n_classes=2
    dataset = Generic_WSI_Classification_Dataset(csv_path = 'dataset_csv/ESCC_MPR_clam.csv',
                            shuffle = False,
                            seed = args.seed,
                            print_info = True,
