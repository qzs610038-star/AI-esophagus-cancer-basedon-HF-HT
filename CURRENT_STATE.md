...
> State revision: `255` | Updated: `2026-09-04T13:40:59+00:00` | Source commit: `9adc14b8167c73d9f51959511e306a8d2e8b93cf`
## Current directives
...
- `DIR-20260904-001` [phase2,paper_output,project_maintenance/phase2_sixfold_leave_one_patient_design_deferred_v1]: 用户于2026-09-04明确决定：Phase 2 的6折留一患者设计将在2026-09-05周六组会上与项目成员讨论，当前暂不纳入执行基线。现阶段只可继续沿用已确认的当前MPP2方案开展讨论或稀疏采样原型准备；不得把6折方案写成已批准实验、启动训练或正式论文方法。组会形成明确决定后再复审并更新路线。
...
- Mode: **configurable**; current channel: `gitee`.
- Active channels: gitee; candidate channels: manual_archive, ssh.
...
- Status: **formal_preparation**.
- Accepted baseline anchor: `mpp2_barcode_repair_v003_frozen_baseline_20260711`.
- Planned experiments: phase2_gene_reconstruction_comparison_v001_20260904, phase2_spatial_density_comparison_v001_20260904, phase2_pathology_model_benchmark_v001_20260904.
- Pending inputs: final_paper_mainline, gene_set_membership_and_expression_contract, sparse_sampling_rule_and_matched_random_control, pathology_model_shortlist_and_common_protocol.
- Deferred designs: six_fold_leave_one_patient_out_pending_team_decision.
