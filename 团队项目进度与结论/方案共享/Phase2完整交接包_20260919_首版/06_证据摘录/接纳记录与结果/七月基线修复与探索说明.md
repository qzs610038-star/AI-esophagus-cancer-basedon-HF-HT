> 历史来源快照（2026-09-19 随包保存）。原文件：团队项目进度与结论/qzs/MPP2基线修复与后续实验进展_20260731.md。保留原记录的时点与解释；后续模型和当前接纳边界见本包正文。D 盘深层链接需要原仓库。
...
**实验完成日期：2026年7月11日。** 以最终一次成功结果生成时间为准；[结果证据](D:/AI空间转录病理研究/PFMval_new/automation/results/mpp2-repair-v003-frozen-20260711-r002/attempt-003/result.json)。
...
- [患者与 barcode 一一对应检查](D:/AI空间转录病理研究/PFMval_new/scripts/rebuild_zscore_from_manifest.py#L97)
- [只在训练集上计算 z-score 参数](D:/AI空间转录病理研究/PFMval_new/scripts/rebuild_zscore_from_manifest.py#L233)
- [将训练集参数应用到其他数据](D:/AI空间转录病理研究/PFMval_new/scripts/rebuild_zscore_from_manifest.py#L254)
- [MPP2 两层 MLP 预测头](D:/AI空间转录病理研究/PFMval_new/train_mpp_uni2h_mlp.py#L106)
- [模型单轮训练过程](D:/AI空间转录病理研究/PFMval_new/train_mpp_uni2h_mlp.py#L124)
...
![MPP2 修复前后外部指标比较](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/01_基线与数据修复/01_mpp2_repair_before_after.png)
...
- [实验结果登记表](../实验登记摘录.json)
- [修复后基线指标](D:/AI空间转录病理研究/PFMval_new/automation/results/mpp2-repair-v003-frozen-20260711-r002/attempt-003/metrics.json)
...
**实验完成日期：2026年7月12日。** 以成功结果生成时间为准；[结果证据](D:/AI空间转录病理研究/PFMval_new/automation/results/mpp2-paired-s1-lora-r8-smoke-20260712-r002/r001/result.json)。
...
- [LoRA 参数注入](D:/AI空间转录病理研究/PFMval_new/model_mpp_uni2h_lora.py#L67)
- [限定优化器只更新 MLP 与 LoRA 参数](D:/AI空间转录病理研究/PFMval_new/model_mpp_uni2h_lora.py#L93)
- [构建冻结对照和 LoRA 模型](D:/AI空间转录病理研究/PFMval_new/train_mpp_uni2h_lora.py#L347)
- [根据内部验证 loss 选择最佳轮次](D:/AI空间转录病理研究/PFMval_new/train_mpp_uni2h_lora.py#L407)
- [完成内部选择后再评估 XZY](D:/AI空间转录病理研究/PFMval_new/train_mpp_uni2h_lora.py#L455)
...
![LoRA 与冻结对照总体指标](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/02_LoRA配对/chart2_lora_comparison.png)

![内部验证患者变化](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/02_LoRA配对/chart3_patient_slope.png)

![外部空间重采样区间](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/02_LoRA配对/chart4_bootstrap_ci.png)

![30 条通路 PCC 变化](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/02_LoRA配对/chart5_pathway_comparison.png)

数据来源：

- [配对实验复核记录](D:/AI空间转录病理研究/PFMval_new/automation/logs/mpp2_paired_smoke_review_20260712.md)
- [绘图数据汇总](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/02_LoRA配对/plot_data_summary.csv)
...
**实验完成日期：2026年7月14日。** 以成功结果生成时间为准；[结果证据](D:/AI空间转录病理研究/PFMval_new/automation/results/mpp2-lora-r8-dropout10-smoke-20260714-r001/r002/result.json)。
...
- [LoRA dropout 参数入口](D:/AI空间转录病理研究/PFMval_new/train_mpp_uni2h_lora.py#L86)
- [将 dropout 传入 LoRA 层](D:/AI空间转录病理研究/PFMval_new/train_mpp_uni2h_lora.py#L347)
- [LoRA 层实际注入实现](D:/AI空间转录病理研究/PFMval_new/model_mpp_uni2h_lora.py#L67)
- [dropout=0.10 实验结果](D:/AI空间转录病理研究/PFMval_new/automation/results/mpp2-lora-r8-dropout10-smoke-20260714-r001/r002/result.json)
...
![S0、LoRA dropout=0 与 dropout=0.10 对比](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/03_LoRA_dropout/03_lora_dropout_comparison.png)

图中比较内部验证 loss、内部验证 PCC、外部 PCC 和 Raw MAE。内部验证指标用于决定是否继续研究，外部 XZY 仅用于完成固定方案后的描述性评估。

数据来源：

- [S0/S1 实验登记](../实验登记摘录.json)
- [dropout=0.10 实验结果](D:/AI空间转录病理研究/PFMval_new/automation/results/mpp2-lora-r8-dropout10-smoke-20260714-r001/r002/result.json)
...
**实验完成日期：2026年7月18日（北京时间）。** 结果文件记录的生成时间为 `2026-07-17T16:05:16+00:00`，换算为北京时间是 2026年7月18日 00:05；[结果证据](D:/AI空间转录病理研究/PFMval_new/automation/results/mpp2-pathway-ridge-calibration-20260717-r003/result.json)。
...
- [Ridge 校准主流程](D:/AI空间转录病理研究/PFMval_new/scripts/fit_mpp2_pathway_ridge_calibration.py#L176)
- [只读取内部验证患者](D:/AI空间转录病理研究/PFMval_new/scripts/fit_mpp2_pathway_ridge_calibration.py#L199)
- [患者留一验证与最终校准器拟合](D:/AI空间转录病理研究/PFMval_new/scripts/fit_mpp2_pathway_ridge_calibration.py#L246)
- [固定校准器后首次读取 XZY](D:/AI空间转录病理研究/PFMval_new/scripts/fit_mpp2_pathway_ridge_calibration.py#L316)
- [外部结果判断与模型包生成条件](D:/AI空间转录病理研究/PFMval_new/scripts/fit_mpp2_pathway_ridge_calibration.py#L350)
...
![Ridge 校准前后外部指标](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/04_Ridge校准/04a_ridge_external_metrics.png)

![30 条通路 Raw R² 变化](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/04_Ridge校准/04b_ridge_pathway_delta_r2.png)

![空间分组下的 Raw R² 变化区间](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/04_Ridge校准/04c_ridge_spatial_interval.png)

数据来源：[Ridge r003 完整结果目录](D:/AI空间转录病理研究/PFMval_new/automation/results/mpp2-pathway-ridge-calibration-20260717-r003)
...
**实验完成日期：2026年7月29日。** 以配对实验科学结论关闭记录日期为准；[关闭记录](D:/AI空间转录病理研究/PFMval_new/project_state/governance/G14_W001_paired_scientific_closeout_receipt_20260729.md)。
...
- [MSE 与 Huber 损失函数选择](D:/AI空间转录病理研究/PFMval_new/train_mpp_uni2h_mlp.py#L86)
- [训练时应用所选损失函数](D:/AI空间转录病理研究/PFMval_new/train_mpp_uni2h_mlp.py#L124)
- [MSE 实验配置](D:/AI空间转录病理研究/PFMval_new/automation/jobs/W001-A003/job.json)
- [Huber 实验配置](D:/AI空间转录病理研究/PFMval_new/automation/jobs/W001-A004/job.json)
- [最终结果复核记录](D:/AI空间转录病理研究/PFMval_new/project_state/governance/G14_W001_paired_scientific_closeout_receipt_20260729.md)
...
![MSE 与 Huber pooled PCC 对比](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/05_MSE与Huber/05a_mse_huber_pooled_pcc.png)

![Huber 逐通路改善方向计数](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/05_MSE与Huber/05b_huber_pathway_direction.png)

第二张图只表示 17/30 与 13/30 的方向计数，不表示总体性能提高，也不表示统计显著。

![MSE 与 Huber 平均逐通路 Raw R²](D:/AI空间转录病理研究/PFMval_new/团队项目进度与结论/qzs/可视化图表/05_MSE与Huber/05c_mse_huber_mean_pathway_raw_r2.png)
...
- [实验结果登记表](../实验登记摘录.json)
- [G14 最终结果复核](D:/AI空间转录病理研究/PFMval_new/project_state/governance/G14_W001_paired_scientific_closeout_receipt_20260729.md)
- [科学结论记录](D:/AI空间转录病理研究/PFMval_new/project_state/scientific_records.jsonl)
