...
def initiate_model(args, ckpt_path, device='cuda'):
    ...
    if args.model_size is not None and args.model_type in ['clam_sb', 'clam_mb', 'mean_pool', 'max_pool']:
        model_dict.update({"size_arg": args.model_size})

    if args.model_type in ['clam_sb', 'clam_mb', 'mean_pool', 'max_pool'] and getattr(args, 'fusion_mode', 'none') != 'none':
        model_dict.update({
