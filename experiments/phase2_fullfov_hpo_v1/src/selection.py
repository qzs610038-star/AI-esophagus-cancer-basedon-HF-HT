...
def recommend_arm(per_arm: dict[str, dict], *, pcc_tolerance: float = 1e-6) -> dict:
        ...
        ranked.append(
            {
                ...
                "inference_parameters": int(
                    stats.get("inference_parameters", 0)
                ),
    ...
    return {
        ...
        "ranking": ranked,
        "rule": "mean_patient_macro_pathway_pcc -> mean_patient_macro_z_mse_selection -> fewer_inference_params -> point/spatial/no_b",
