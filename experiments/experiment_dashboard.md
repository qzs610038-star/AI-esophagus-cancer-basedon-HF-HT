...
> Auto-generated by `finalize_experiment.py`. Last updated: 2026-08-16T14:20:00+00:00.
...
>
> ✅ **当前 MPP 主线（2026-08-16）**：MPP2。MPP2 remains the only downstream follow-up scheme. Repaired-data MPP1/3/4/5 frozen rechecks are accepted comparison evidence, not independent training routes. MPP2 LoRA r=8 remains engineering_pass/candidate_effectiveness_fail/no_go_formal.
> 下一步推荐：Review the pending W007 deep-attribution analysis and interpretation reports; four-arm verification is accepted. Do not auto-launch MPP2 LoRA r=8 formal training.。
>
